...
namespace Maticsoft.DAL
{
	...
	public partial class clutercapacity
	{
		...
		public int GetMaxId()
		{
		return DbHelperMySQL.GetMaxID("id", "clutercapacity"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from clutercapacity");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from clutercapacity ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,totalCapacity,usedCapacity ");
			strSql.Append(" FROM clutercapacity ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from clutercapacity T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "clutercapacity";
